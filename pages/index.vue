<template>
    ...
    <div class="container">
    <h3 style="font-weight:normal;padding-bottom:10px; font-family: -apple-system,BlinkMacSystemFont,SFUI,HelveticaNeue,Helvetica,Arial,sans-serif; color: rgba(0, 0, 0, 0.65)">Log in to continue...</h3>
      <div class="box">
...
export default {
    ...
    methods: {
        login() {
            ...
            this.firebase_push_db({ ref: "credentials", obj }, (res) => {
